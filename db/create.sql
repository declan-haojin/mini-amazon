...
CREATE TABLE Purchases(
    ...
    purchase_id INT UNIQUE NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
CREATE TABLE Orders(
    ...
    order_id INT UNIQUE NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    number_of_items INT NOT NULL,
    amount DECIMAL(12,2) NOT NULL,
    status VARCHAR NOT NULL,
    product_id INT NOT NULL REFERENCES Products(product_id),
    seller_id INT NOT NULL REFERENCES Sellers(seller_id),
    update_at timestamp without time zone NOT NULL DEFAULT (current_timestamp AT TIME ZONE 'UTC'),
